...
def run_sql_script(sql_file_path):
    """
    Run an given SQL script.
    Args:
        sql_file_path: path to the SQL file to be run
    """
...
def run_sql_script_without_transaction(sql_file_path):
    """
    Run an given SQL script without transactions. this should be used only when the actions in the script are individually atomic.
    Args:
        sql_file_path: path to the SQL file to be run
    """
    with open(sql_file_path) as sql:
